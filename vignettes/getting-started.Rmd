...
```{r}
examplecountdata <- example_data(which_data = "count")
...
```{r}
examplemetadata <- example_data(which_data = "meta")
```

```{r}
colnames(examplemetadata)
```
...
```{r}
example_counts <- examplecountdata %>%
